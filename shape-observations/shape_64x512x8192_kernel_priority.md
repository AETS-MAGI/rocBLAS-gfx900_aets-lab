# Shape Kernel Priority Memo: 64x512x8192 (Queue-C)
...
- baseline: `64x512x8192`
- side counterpart: `64x1024x8192`

## 2. Stable observation snapshot

- [main-node confirmed] baseline lane:
  - `shape_64x512x8192=24` (`prefill -> full: 24 -> 24`, `delta=0`)
  - `direct/fallback/dispatch=1`
- [main-node confirmed] side lane:
  - `shape_64x1024x8192=36` (`prefill -> full: 36 -> 36`, `delta=0`)
  - `direct/fallback/dispatch=1`
...
```mermaid
flowchart LR
    S[Shape pair<br/>64x512x8192 / 64x1024x8192] --> K1[K1: BBS_BH]
    S --> K2[K2: HB_GB]
    S --> K3[K3: HSS_BH_GB]
