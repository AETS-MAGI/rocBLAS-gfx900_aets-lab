# Shape Kernel Priority Memo: 4608x512x64 (Queue-C)
...
- baseline: `4608x512x64`
- side related family: `5120x1024x64`, `8192x1024x64`

## 2. Stable observation snapshot

- [main-node confirmed] baseline lane:
  - `shape_4608x512x64=24` (`prefill -> full: 24 -> 24`, `delta=0`)
  - `direct/fallback/dispatch=1`
- [main-node confirmed] side lane (related `k=64` family):
  - `shape_5120x1024x64=36`, `shape_8192x1024x64=36` (both `delta=0`)
  - `direct/fallback/dispatch=1`
...
```mermaid
flowchart LR
    S[Shape family<br/>4608x512x64 / 5120x1024x64 / 8192x1024x64] --> K1[K1: BBS_BH]
    S --> K2[K2: HB_GB]
    S --> K3[K3: HSS_BH_GB]
