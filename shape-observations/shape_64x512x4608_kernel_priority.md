# Shape Kernel Priority Memo: 64x512x4608 (Queue-C)
...
- baseline: `64x512x4608`
- side related family: `64x1024x5120`, `64x1024x8192`

## 2. Stable observation snapshot

- [main-node confirmed] baseline lane:
  - `shape_64x512x4608=24` (`prefill -> full: 24 -> 24`, `delta=0`)
  - `direct/fallback/dispatch=1`
- [main-node confirmed] side lane (related transpose family):
  - `shape_64x1024x5120=36`, `shape_64x1024x8192=36` (both `delta=0`)
  - `direct/fallback/dispatch=1`
...
```mermaid
flowchart LR
    S[Shape family<br/>64x512x4608 / 64x1024x5120 / 64x1024x8192] --> K1[K1: BBS_BH]
    S --> K2[K2: HB_GB]
    S --> K3[K3: HSS_BH_GB]
...
- [inference] This memo is queue-C shape-family prioritization, not single-shape dispatch proof.
