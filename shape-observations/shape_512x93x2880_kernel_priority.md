# Shape Kernel Priority Memo: 512x93x2880 (Queue-B)
...
- baseline: `512x93x2880`
- side: `512x93x2880` (same shape observed in side lane)

## 2. Stable observation snapshot

- [main-node confirmed] baseline lane:
  - `shape_512x93x2880=48` (`prefill -> full: 48 -> 48`, `delta=0`)
...
```mermaid
flowchart LR
    S[Shape pair<br/>512x93x2880 / 512x93x2880] --> K1[K1: BBS_BH]
    S --> K2[K2: HB_GB]
    S --> K3[K3: HSS_BH_GB]
